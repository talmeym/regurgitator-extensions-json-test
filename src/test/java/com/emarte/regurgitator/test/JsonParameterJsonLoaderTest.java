...
public class JsonParameterJsonLoaderTest extends JsonBaseTest {
	...
	public void testMaxFlat() throws IOException, RegurgitatorException {
		assertExpectation("classpath:/JsonParameter_max_flat.json", "com.emarte.regurgitator.extensions.JsonParameter:['json-parameter-1',com.emarte.regurgitator.core.ParameterPrototype:['name',com.emarte.regurgitator.core.NumberType:[],com.emarte.regurgitator.core.ConflictPolicy:LEAVE],'context',com.emarte.regurgitator.core.ContextLocation:['context:location'],com.emarte.regurgitator.extensions.JsonPathProcessor:['jsonpath.jsonpath'],com.emarte.regurgitator.test.stuff.TestValueProcessor:[]]");
	}
